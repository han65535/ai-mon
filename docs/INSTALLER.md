...
- 파일: `out/Installer/AI-Mon-0.2.0-x64-en.msi`
- 형식: Windows Installer MSI, 압축 CAB 내장
- 크기: **172,032바이트** (168KiB)
- 포함된 앱: `ai-mon.exe`, **348,160바이트**
...
업데이트·복구·제거 전에는 실행 중인 앱을 트레이의 **종료** 메뉴로 닫는다.
...
```powershell
msiexec /i "AI-Mon-0.2.0-x64-en.msi" /qn /norestart
```
